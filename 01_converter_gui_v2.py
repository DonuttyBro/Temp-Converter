...
class Converter:
    ...
    def __init__(self):
        ...
        self.to_helpinfo_button = Button(self.button_frame, text="Help / Info", bg="#CC6600", fg=button_fg, font=button_font, width=12)
        self.to_helpinfo_button.grid(row=1, column=0, padx=5, pady=5)
    ...
    def to_celsius(self):
        ...
        if to_convert != "invalid":
            # do calculation
            self.var_feedback.set("Converting {} to Celsius".format(to_convert))
    ...
    def to_fahrenheit(self):
        ...
        if to_convert != "invalid":
            # do calculation
            self.var_feedback.set("Converting {} to Fahrenheit".format(to_convert))
