...
# if filename is blank, returns default name. Otherwise checks filename and either returns an error or returns the filename (with .txt extension)
...
# checks that filename only contains letters, numbers and underscores. Returns either "" if OK or the problem if we have an error.
