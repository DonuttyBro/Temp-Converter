...
class Converter:
    ...
    def __init__(self):
        ...
        self.to_histexp_button = Button(self.button_frame, text="History / Export", bg="#004C99", fg=button_fg, font=button_font, width=12, state=DISABLED)
        self.to_histexp_button.grid(row=1, column=1, padx=5, pady=5)
    ...
    def check_temp(self, min_value):
        ...
        # If we have no errors...
            ...
            self.to_histexp_button.config(state=NORMAL)
            return response
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text = "To use the program, simply enter the temperature you wish to convert and then choose to convert to either degrees Celsius or Fahrenheit... \n\n Note that -273 degrees Celsius or -459 degrees Fahreinheit is absolute zero (the coldest possible temperature). If you try to convert a temperature less than absolute zero you will get an error message. \n\n To see your calculation history and export it to a text file, please click the 'History / Export' button."
