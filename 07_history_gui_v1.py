...
class HistoryExport:
    ...
    def __init__(self, partner, calc_list):
        ...
        if num_calcs > max_calcs:
            ...
            showing_all = "Below is you calculation history."
    ...
    def get_calc_string(self, var_calculations):
        ...
        #  work out how many times to loop to output either the last five calculations or all the calculations
        ...
        # add final item without an extra line break (ie: last item on list will be fifth from the end)
